...
.data 
filename01 BYTE "C:\steghide_assembly\output\Create0.txt",0
filename02 BYTE "C:\steghide_assembly\output\Create0.bmp",0
filename03 BYTE "C:\steghide_assembly\output\Create0.jpg",0
filename04 BYTE "C:\steghide_assembly\output\Create0.exe",0
...
byte2file proc,
	...
	.IF fileType==1
		INVOKE CreateFile,
		ADDR filename01, ; ptr to filename
	...
	.IF fileType==2
		INVOKE CreateFile,
		ADDR filename02, ; ptr to filename
		GENERIC_WRITE, ; access mode
		0, ; share mode
		0, ; ptr to security attributes
		CREATE_ALWAYS, ; file creation options
	...
	.IF fileType==3
		INVOKE CreateFile,
		ADDR filename03, ; ptr to filename
		GENERIC_WRITE, ; access mode
		0, ; share mode
		0, ; ptr to security attributes
		CREATE_ALWAYS, ; file creation options
	...
	.IF fileType==4
		INVOKE CreateFile,
		ADDR filename04, ; ptr to filename
		GENERIC_WRITE, ; access mode
		0, ; share mode
		0, ; ptr to security attributes
		CREATE_ALWAYS, ; file creation options
